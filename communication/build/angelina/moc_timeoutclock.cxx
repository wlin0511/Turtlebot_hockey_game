...
#include "../../angelina/timeoutclock.h"
...
static const char qt_meta_stringdata_TimeoutClock[] = {
    "TimeoutClock\0\0ring()\0value\0newTime(int)\0"
    "slotTick()\0"
};
...
const QMetaObjectExtraData TimeoutClock::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TimeoutClock::staticMetaObject = {
    { &QTimer::staticMetaObject, qt_meta_stringdata_TimeoutClock,
      qt_meta_data_TimeoutClock, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TimeoutClock::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TimeoutClock))
