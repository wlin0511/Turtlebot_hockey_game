...
static const char qt_meta_stringdata_RatioTask[] = {
    "RatioTask\0\0slotTimeOver()\0"
};
...
const QMetaObjectExtraData RatioTask::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject RatioTask::staticMetaObject = {
    { &Task::staticMetaObject, qt_meta_stringdata_RatioTask,
      qt_meta_data_RatioTask, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RatioTask::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RatioTask))
